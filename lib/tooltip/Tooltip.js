...
var tooltipFactory = function tooltipFactory() {
  ...
  var defaultShowOnClick = _defaults$options.showOnClick;
    ...
    var TooltippedComponent = function (_Component) {
      ...
      _createClass(TooltippedComponent, [{
        ...
        value: function render() {
          ...
          var tooltipShowOnClick = _props.tooltipShowOnClick;

          var other = _objectWithoutProperties(_props, ['children', 'className', 'theme', 'tooltip', 'tooltipDelay', 'tooltipHideOnClick', 'tooltipPosition', 'tooltipShowOnClick']);
